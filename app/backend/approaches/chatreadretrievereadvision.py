...
class ChatReadRetrieveReadVisionApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """
        You are an expert in finding information about electricity transmission codes such as the Connection and Use of System Code (CUSC), the Grid Code (GC), the System Operator – Transmission Owner Code (STC), and the Security & Quality of Supply Standard (SQSS)., The documents contain text, graphs, tables and images.
